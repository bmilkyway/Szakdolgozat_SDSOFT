...
namespace CRM.EntityFramework.Migrations
{
    ...
    [Migration("20221028125529_init8")]
    partial class init8
    {
            ...
            modelBuilder.Entity("CRM.Domain.Models.Feedback", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            FeedbackDate = new DateTime(2022, 10, 28, 14, 55, 29, 530, DateTimeKind.Local).AddTicks(3286),
                            FeedbackDescription = "Ez az első visszajelzés",
                            FeedbackType = "Visszajelzés",
                            FeedbackUserId = 1,
            ...
            modelBuilder.Entity("CRM.Domain.Models.Message", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SendDate = new DateTime(2022, 10, 28, 14, 55, 29, 533, DateTimeKind.Local).AddTicks(6666),
                            Subject = "Első levél",
                            ToUserId = 1,
                            isRead = false
                        });
            ...
            modelBuilder.Entity("CRM.Domain.Models.Task", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = "Prgramozás",
                            CreateDate = new DateTime(2022, 10, 28, 14, 55, 29, 533, DateTimeKind.Local).AddTicks(8660),
                            CreatedUserId = 1,
            ...
            modelBuilder.Entity("CRM.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            LoginDate = new DateTime(2022, 10, 28, 14, 55, 29, 533, DateTimeKind.Local).AddTicks(4758),
                            Name = "Bajár Milán",
                            Password = "Admin",
                            PermissionId = 1,
                            RegistrationDate = new DateTime(2022, 10, 28, 14, 55, 29, 533, DateTimeKind.Local).AddTicks(4266),
                            UserName = "Admin"
                        });
                });
