...
namespace CRM.EntityFramework.Migrations
{
    ...
    [Migration("20221027231109_init6")]
    partial class init6
    {
            ...
            modelBuilder.Entity("CRM.Domain.Models.Message", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SendDate = new DateTime(2022, 10, 28, 1, 11, 8, 703, DateTimeKind.Local).AddTicks(3115),
                            Subject = "Első levél",
                            ToUserId = 1,
                            isRead = false
                        });
            ...
            modelBuilder.Entity("CRM.Domain.Models.Task", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = "Prgramozás",
                            CreateDate = new DateTime(2022, 10, 28, 1, 11, 8, 703, DateTimeKind.Local).AddTicks(5162),
                            CreatedUserId = 1,
            ...
            modelBuilder.Entity("CRM.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            LoginDate = new DateTime(2022, 10, 28, 1, 11, 8, 703, DateTimeKind.Local).AddTicks(1307),
                            Name = "Bajár Milán",
                            Password = "Admin",
                            PermissionId = 1,
                            RegistrationDate = new DateTime(2022, 10, 28, 1, 11, 8, 703, DateTimeKind.Local).AddTicks(824),
                            UserName = "Admin"
                        });
                });
