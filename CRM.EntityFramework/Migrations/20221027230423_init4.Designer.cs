...
namespace CRM.EntityFramework.Migrations
{
    ...
    [Migration("20221027230423_init4")]
    partial class init4
    {
            ...
            modelBuilder.Entity("CRM.Domain.Models.Message", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SendDate = new DateTime(2022, 10, 28, 1, 4, 23, 38, DateTimeKind.Local).AddTicks(8828),
                            Subject = "Első levél",
                            ToUserId = 1,
                            isRead = false
                        });
            ...
            modelBuilder.Entity("CRM.Domain.Models.Task", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = "Prgramozás",
                            CreateDate = new DateTime(2022, 10, 28, 1, 4, 23, 39, DateTimeKind.Local).AddTicks(1872),
                            CreatedUserId = 1,
            ...
            modelBuilder.Entity("CRM.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            LoginDate = new DateTime(2022, 10, 28, 1, 4, 23, 37, DateTimeKind.Local).AddTicks(8978),
                            Name = "Bajár Milán",
                            Password = "Admin",
                            PermissionId = 1,
                            RegistrationDate = new DateTime(2022, 10, 28, 1, 4, 23, 36, DateTimeKind.Local).AddTicks(1007),
                            UserName = "Admin"
                        });
                });
