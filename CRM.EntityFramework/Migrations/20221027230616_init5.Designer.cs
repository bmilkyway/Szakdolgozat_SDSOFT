...
namespace CRM.EntityFramework.Migrations
{
    ...
    [Migration("20221027230616_init5")]
    partial class init5
    {
            ...
            modelBuilder.Entity("CRM.Domain.Models.Message", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SendDate = new DateTime(2022, 10, 28, 1, 6, 15, 913, DateTimeKind.Local).AddTicks(5398),
                            Subject = "Első levél",
                            ToUserId = 1,
                            isRead = false
                        });
            ...
            modelBuilder.Entity("CRM.Domain.Models.Task", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = "Prgramozás",
                            CreateDate = new DateTime(2022, 10, 28, 1, 6, 15, 913, DateTimeKind.Local).AddTicks(7432),
                            CreatedUserId = 1,
            ...
            modelBuilder.Entity("CRM.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            LoginDate = new DateTime(2022, 10, 28, 1, 6, 15, 912, DateTimeKind.Local).AddTicks(6301),
                            Name = "Bajár Milán",
                            Password = "Admin",
                            PermissionId = 1,
                            RegistrationDate = new DateTime(2022, 10, 28, 1, 6, 15, 910, DateTimeKind.Local).AddTicks(8024),
                            UserName = "Admin"
                        });
                });
