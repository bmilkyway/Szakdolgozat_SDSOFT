    ...
    public class CRM_DbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Feedback>().HasData(
                new Feedback {FeedbackName="Visszajelzés", Id = 1, FeedbackDate = DateTime.Now,  FeedbackDescription = "Ez az első visszajelzés", FeedbackType = "Hiba", FeedbackUserId = 1, isRead = false, isRevised = false });
